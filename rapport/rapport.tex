...
%%%%%%%%%%%%%%%% Variables %%%%%%%%%%%%%%%%
\def\projet{3}
\def\titre{Méthodes d’interpolation et d’intégration/ Splines cubiques et interpolation de surface}
\def\groupe{1}
\def\equipe{2}
...
%%%%%%%%%%%%%%%% Main part %%%%%%%%%%%%%%%%
\input{rapport/chapters/part1.tex}
\input{rapport/chapters/part2.tex}
\input{rapport/chapters/part3.tex}
